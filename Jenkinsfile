        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/miraclito/sys_almacen.git'
                }
            }
        }
        stage('Build') {
